...
namespace Atlassian\Traits;

use Exception;
use Atlassian\Exceptions\FailedActionException;
use Atlassian\Exceptions\NotFoundException;
use Atlassian\Exceptions\ValidationException;
